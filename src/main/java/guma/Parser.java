...
public class Parser {
    ...
    private static AddCommand parseToDoCommand(String fullCommand) {
        try {
            ...
            throw new GumaException(">> Ensure your Syntax: todo <taskname>");
        }
    }
    ...
    private static AddCommand parseDeadlineCommand(String fullCommand) {
        ...
        try {
            ...
            throw new GumaException(">> Ensure your Syntax: deadline <taskname> /by <description>");
        }
    }
    ...
    private static AddCommand parseEventCommand(String fullCommand) {
        try {
            ...
            throw new GumaException(">> Ensure your Syntax: event <taskname> /from <Start time> /to <End time>");
        }
    }
    ...
    private static FindCommand parseFindCommand(String fullCommand) {
        try {
            ...
            throw new GumaException(">> Ensure your Syntax: find <taskname>");
        }
    }
    ...
    private static ScheduleCommand parseScheduleCommand(String fullCommand) {
        try {
            ...
            throw new GumaException(">> Ensure your Syntax: schedule /on dd/MM/yyyy");
        }
    }
